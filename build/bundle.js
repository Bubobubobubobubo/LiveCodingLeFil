...
var app = (function () {
    ...
    var information = {performers, posters};
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = `${/*all_titles*/ ctx[2][Math.floor(Math.random() * 3)]}`;
    			attr_dev(h1, "class", "bigtitle svelte-1c2yk31");
    			add_location(h1, file, 30, 6, 2723);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1.textContent = ":'((((";
    			attr_dev(h1, "class", "bigtitle svelte-1c2yk31");
    			add_location(h1, file, 28, 12, 2668);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:3) {#each shuffled as p}",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_1 = /*shuffled*/ ctx[1];
    ...
    function create_default_slot_1(ctx) {
    	...
    	performerdescription = new PerformerDescription({
    			props: {
    				name: /*p*/ ctx[3].pseudo,
    				url_portrait: /*p*/ ctx[3].url_portrait,
    				pseudo: /*p*/ ctx[3].fullname,
    				link: /*p*/ ctx[3].link,
    				description: /*p*/ ctx[3].description,
    				video: /*p*/ ctx[3].video
    			},
    			$$inline: true
    		});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each shuffled as p}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isMobileUser*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 41, 2, 3185);
    			...
    			add_location(img1, file, 42, 2, 3227);
    			...
    			add_location(img2, file, 43, 2, 3270);
    			attr_dev(div1, "class", "posters svelte-1c2yk31");
    			add_location(div1, file, 40, 1, 3161);
    			attr_dev(main, "class", "svelte-1c2yk31");
    			add_location(main, file, 25, 0, 2612);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({
    		...
    		MoreInformation,
    		performers: information.performers,
    	...
    	$$self.$inject_state = $$props => {
    		if ('shuffled' in $$props) $$invalidate(1, shuffled = $$props.shuffled);
    		if ('all_titles' in $$props) $$invalidate(2, all_titles = $$props.all_titles);
    	};
    	...
    	return [isMobileUser, shuffled, all_titles];
    }
