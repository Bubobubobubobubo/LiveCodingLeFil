    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file, 29, 2, 938);
    			...
    			add_location(img1, file, 30, 2, 980);
    			...
    			add_location(img2, file, 31, 2, 1023);
    			attr_dev(div1, "class", "posters svelte-1c2yk31");
    			add_location(div1, file, 28, 1, 914);
    			attr_dev(main, "class", "svelte-1c2yk31");
    			add_location(main, file, 17, 0, 471);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
